package no.nav.dokdistdittnav.nais;
...
import no.nav.dokdistdittnav.nais.selftest.DependencyCheckResult;
import no.nav.dokdistdittnav.nais.selftest.Importance;
import no.nav.dokdistdittnav.nais.selftest.Result;
import no.nav.dokdistdittnav.nais.selftest.SelftestResult;
